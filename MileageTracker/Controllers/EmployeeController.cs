...
namespace MileageTracker.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName")] EmployeeModel employeeModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName")] EmployeeModel employeeModel)
        {
            if (ModelState.IsValid)
            {
